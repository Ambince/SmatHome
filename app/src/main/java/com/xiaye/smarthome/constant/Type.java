...
public interface Type {
    ...
    public static final int SELECT_GROUPMEMBER5 = 0x80201054;//查询设备别名，虚拟地址，地址，端口（包括加入群组和没加入群组）
    ...
    public static final int GROUP_DEVICE_POWON = 0x10000032;//向群组发送“增加亮度”命令
    public static final int GROUP_DEVICE_POWOFF = 0x10000033;//向群组发送“降低亮度”命令
