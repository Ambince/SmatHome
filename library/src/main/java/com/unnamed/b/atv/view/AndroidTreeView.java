...
public class AndroidTreeView {
    ...
    public void setSelectionModeEnabled(boolean selectionModeEnabled ,int j,int i) {
    ...
    public void selectAll(boolean skipCollapsed,int j,int i) {
        makeAllSelection(true, skipCollapsed,j,i);
    }

    public void deselectById(int j,int i) {
        makeAllSelection(false, false,j,i);
    }

    private void makeAllSelection(boolean selected, boolean skipCollapsed,int j,int i) {
        if (mSelectionModeEnabled) {
            TreeNode    node =mRoot.getChildren().get(j).getChildren().get(i);
//            for (TreeNode node : mRoot.getChildren()) {
...
//            parent.getChildren().get(i).setSelectable(selected);
